	...
	<section className={cn("left_sidebar h-[calc(100vh-5px)]", {
		...
		<nav className='flex flex-col gap-6'>
			...
			{sidebarLinks.map(({route,label,imgURL})=>{
			  ...
			  {user && (
				  <Link href={`/profile/${user.id}`} className={cn("flex gap-3 items-center py-4 max-lg:px-4 justify-center lg:justify-start", {
		...
		<SignedOut>
			<div className='flex-center w-full pb-14 max-lg:px-14 lg:pr-8'>
