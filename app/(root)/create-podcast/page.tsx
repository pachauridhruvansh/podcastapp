...
//           <Button type="submit"
//           className="text-16 bg-orange-1 text-white-1 font-extrabold py-4 w-full transistion-all duration-500 hover:bg-black-1"
...
const CreatePodcast = () => {
  ...
  // const [voiceType, setVoiceType] = useState<string | null>(null);
  const [voiceType, setVoiceType] = useState<string>('Scarlett') // Set default voiceType
  const [voicePrompt, setVoicePrompt] = useState('');
